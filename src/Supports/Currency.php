...
class Currency
{
    ...
    private function loadAmount(string|float|int|null $amount = 0.0): void
    {
        ...
        $this->amount = ($values[0] != '')
            ? (int)filter_var($values[0], FILTER_SANITIZE_NUMBER_INT)
            : 0;

        $this->subunit = (isset($values[1]))
            ? str_pad(filter_var($values[1], FILTER_SANITIZE_NUMBER_INT), $this->config['precision'], "0")
            : '0';
    }
